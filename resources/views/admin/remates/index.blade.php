                ...
                <div class="col-md-12 mb-3">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Botón para mostrar detalles de los ganadores -->
                            @if($remate->estado == 2 && $remate->productos->isNotEmpty())
                                <button class="btn btn-info" data-bs-toggle="collapse" data-bs-target="#ganadores{{ $remate->id_remates }}" aria-expanded="false" aria-controls="ganadores{{ $remate->id_remates }}">
                                    Mostrar Ganadores
                                </button>

                                <div class="collapse" id="ganadores{{ $remate->id_remates }}">
                                    <div class="card card-body mt-2">
                                        <h4>Ganadores del Remate: {{ $remate->nombre }}</h4>
                                        @foreach($remate->productos as $producto)
