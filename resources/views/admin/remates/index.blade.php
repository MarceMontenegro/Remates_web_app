                ...
                <div class="col-md-12 mb-3">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Mostrar ganador si el remate ha finalizado -->
                            @if($remate->estado == 2 && $remate->ofertas->isNotEmpty())
                                <p><strong>Ganador:</strong> {{ $remate->ofertas->first()->usuario->name }}</p>
                                <p><strong>Monto Ganador:</strong> ${{ $remate->ofertas->first()->monto }}</p>
                            @endif
                        </div>
                        <div class="card-footer text-right">
                            @if(auth()->check())
